  ...
  data: [
    {
      ...
      estimated_salaries: [
        ...
        },
        {
          ...
          publisher_link:
            'https://www.randstadusa.com/salary/python-developer-salaries/dallas-texas',
          min_salary: 111297,
          max_salary: 168588,
      ...
      apply_options: [
        {
          ...
          apply_link:
            'https://www.ziprecruiter.com/c/Infosys-Limited/Job/Python-Developer/-in-Dallas,TX?jid=247bba0a2a494c6b&utm_campaign=google_jobs_apply&utm_source=google_jobs_apply&utm_medium=organic',
          is_direct: false,
        },
        {
          publisher: 'Lensa',
      ...
      employer_reviews: [
        ...
        },
        {
          ...
          max_score: 5,
          reviews_link:
            'https://www.indeed.com/cmp/Infosys/reviews?utm_campaign=google_jobs_reviews&utm_source=google_jobs_reviews&utm_medium=organic',
        },
        {
...
export default async function (endpoint: string): Promise<{
  data: {data: Array<any>};
}> {
  await delay(1000);
